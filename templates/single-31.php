  ...
  (function ($, root, undefined) {
    ...
    $(function () {
      ...
      if ( ! Detector.webgl ) Detector.addGetWebGLMessage();
			...
			var camera, scene, renderer, container, bulbLight, bulbMat, hemiLight, object, loader;
			...
			function init() {
				container = $("#canvas");
				camera = new THREE.PerspectiveCamera( 50, $(container).width() / $(container).height(), 0.1, 100 );
				camera.position.x = -4;
				camera.position.z = 4;
				camera.position.y = 2;
